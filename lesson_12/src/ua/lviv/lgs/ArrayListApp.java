...
//			System.out.println(object + "____");
		...
		System.out.println(list2.containsAll(list1)); // list1 save reference to the object
		
		System.out.println(list2.get(0));
		System.out.println(list2.size());
		System.out.println(list2.add("add custom text"));
		System.out.println(list2);
		...
		System.out.println("remove index: " + list2.remove(0));
		System.out.println(list2);
		
		System.out.println("remove value: " + list2.remove("A"));
		System.out.println(list2);
